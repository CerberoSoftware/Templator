...
export const footerDef: BlockDef = {
  ...
  render: ({ props, id }: { props: FooterProps; id: string }, ctx) => {
    const tdStyle = outerTdStyle(
      `padding:${props.paddingY}px 24px;background-color:${props.bgColor};font-family:${props.fontFamily};font-size:${props.fontSize}px;line-height:1.5;color:${props.color};text-align:${props.align};`,
      props,
    )
