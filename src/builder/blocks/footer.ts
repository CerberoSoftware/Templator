...
import { alignOf, normalizeColor, paddingY, parseRichContent, renderRich, styleOf } from '../htmlUtils'
...
export const footerDef: BlockDef = {
  ...
  fields: [
    ...
    { key: 'fontSize', label: 'Font size', type: 'number', min: 10, max: 16, step: 1 },
  ...
  render: ({ props, id }: { props: FooterProps; id: string }, ctx) => `<tr${marker(id, ctx)}>
  <td class="et-footer" bgcolor="${props.bgColor}" style="padding:${props.paddingY}px 24px;background-color:${props.bgColor};font-family:${props.fontFamily};font-size:${props.fontSize}px;line-height:1.5;color:${props.color};text-align:${props.align};">
