  ...
  return {
    ...
    blocks: [
      ...
      },
      {
        ...
        props: {
          content:
            'First paragraph with **bold** and a [link](https://example.com/go).\n\nSecond paragraph after a blank line.\n\n- First bullet\n- Second bullet\n\n1. First step\n2. Second step',
          fontSize: 15,
          lineHeight: 1.6,
          fontFamily: DEFAULT_FONT,
          color: '#333333',
      ...
      },
      {
        id: 'b-twocol',
        type: 'twocol',
        props: { ratio: '50-50', gap: 16, paddingTop: 8, paddingBottom: 8, paddingX: 24, blockBg: 'transparent', blockRadius: 0, widthPct: 100 },
        columns: [
          [
            {
              id: 'b-col-text',
      ...
      { id: 'b-divider', type: 'divider', props: { color: '#e7eef6', thickness: 2, paddingTop: 16, paddingBottom: 16, paddingX: 24, blockBg: 'transparent', blockRadius: 0, widthPct: 100 } },
      {
        id: 'b-social',
        type: 'social',
        props: {
